...
if(!file.exists('00SourceAll.R')) {
  ...
  source('base/R/WizardDialog.R',encoding='UTF-8')
  ...
  source('board.upload/R/BatchCorrectModule.R',encoding='UTF-8')
  source('board.upload/R/CheckDataModule.R',encoding='UTF-8')
  source('board.upload/R/ComputePgxModule.R',encoding='UTF-8')
  source('board.upload/R/MakeContrastModule.R',encoding='UTF-8')
  source('board.upload/R/NormalizeCountsModule.R',encoding='UTF-8')
  ...
  source('board.wgcna/R/wgcna_compute.R',encoding='UTF-8')
